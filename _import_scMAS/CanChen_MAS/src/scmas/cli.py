...
from scmas.data.catalog import build_dataset_catalog
from scmas.data.labels import build_seaad_label_maps
from scmas.data.prepare_sources import prepare_generation_sources
from scmas.data.reference import build_reference, build_seaad_test_h5ad
from scmas.eval.datasets import prepare_all_eval_datasets
from scmas.eval.label_transfer import evaluate_raw_label_transfer
from scmas.eval.run import run_evaluation
from scmas.eval.uce_ima import run_uce_ima_label_transfer
from scmas.io import write_json
from scmas.scdesign3.generate import preflight_scdesign3, run_generation_configs, write_generation_configs
from scmas.stage2.selector import profile_query, run_cross_species_plan, select_models
from scmas.stage3.adapter_executor import adapt_and_execute, inspect_model_contracts
from scmas.stage4.consensus import run_consensus
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(prog="scmas", description="scMAS multi-stage annotation workflow")
