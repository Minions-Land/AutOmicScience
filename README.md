...
Aliyun PyPI mirrors are useful for Python packages, but `mirrors.aliyun.com/huggingface` is not a Hugging Face Hub API endpoint for `hf download` or `hf upload-large-folder`.
