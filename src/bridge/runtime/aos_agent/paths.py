...
KUKANJA_MS_NPZ = _path_from_env("AOS_MAS_KUKANJA_MS_NPZ", DATA_DIR / "query" / "kukanja_ms.npz")
KUKANJA_EAE_NPZ = _path_from_env("AOS_MAS_KUKANJA_EAE_NPZ", DATA_DIR / "query" / "kukanja_eae.npz")
...
SPINAL_DIR = LEGACY_DATA_ROOT / "reference" / "spinal"
