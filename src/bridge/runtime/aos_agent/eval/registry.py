...
from aos_agent.io import read_yaml
...
def _default_env_paths() -> dict[str, Path]:
    return {
        ...
        "AOS_MAS_SCGPT_DIR": paths.SCGPT_CHECKPOINT_ROOT,
        "AOS_MAS_NICHEFORMER_DIR": paths.NICHEFORMER_CHECKPOINT_DIR,
        "AOS_MAS_UCE_4L_DIR": paths.UCE_4L_MODEL_DIR,
        "AOS_MAS_UCE_33L_DIR": paths.UCE_33L_MODEL_DIR,
    }
