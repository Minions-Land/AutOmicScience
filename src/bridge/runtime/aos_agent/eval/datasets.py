...
from aos_agent.data.labels import build_seaad_label_maps, factorize_ids, load_merfish_genes, seaad_label_ids_from_obs
from aos_agent.io import ensure_dir, normalize_gene_name, read_standard_bundle, write_json
...
def _write_npz_and_h5ad(
    *,
    ...
    if max_cells and max_cells > 0 and obs.shape[0] > max_cells:
        ...
        from aos_agent.io import stratified_indices
