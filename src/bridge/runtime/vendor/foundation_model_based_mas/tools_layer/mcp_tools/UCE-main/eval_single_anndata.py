...
if __name__ == "__main__":
    ...
    parser.add_argument("--spec_chrom_csv_path",
                        default="/data1/foundation_model_based_mas/model/species_chrom.csv", type=str,
                        help="CSV Path for species genes to chromosomes and start locations.")
    parser.add_argument("--token_file",
                        default="/data1/foundation_model_based_mas/model/all_tokens.torch", type=str,
                        help="Path for token embeddings.")
    parser.add_argument("--protein_embeddings_dir",
                        default="/data1/foundation_model_based_mas/model/protein_embeddings/", type=str,
                        help="Directory where protein embedding .pt files are stored.")
    parser.add_argument("--offset_pkl_path",
                        default="/data1/foundation_model_based_mas/model/species_offsets.pkl", type=str,
